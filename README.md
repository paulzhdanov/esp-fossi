...
<img width="549" height="496" alt="Screenshot 2026-02-18 at 13 12 59" src="https://github.com/user-attachments/assets/c2cacad0-ed2b-4067-a8c9-6dba1e26bff1" />
...
- **Визначення джерела живлення**: розетка чи батарея
...
4. Кожні 25 секунд надсилає MODBUS-запит
5. Парсить відповідь і оновлює дані
6. Віддає дані через HTTP REST API
7. Визначає джерело живлення (розетка/батарея)
...
```json
{
  "c":{"b":[[0,5]],"n":"electro","io":[ [[0],6,1,0], [[5,7],6,1] ]},
  "a":[{
    "t":6,
    "nm":"Electricity-A",
    "f0": [[5,1]],
...
**Аксесуари `"a"`:**
- `Electricity-A` та `Electricity-B` — два індикатори ліній живленя, на GPIO 5 і 7 подано DOUT від сенсорів напруги (основна і резервна лінія)
- 5 штук сенсорів світла + Free Monitor
...
Цей проєкт створений в Україні під час війни. Для українців — безкоштовно.

Якщо ви з іншої країни і цей проєкт вам корисний — будь ласка, задонатьте на гуманітарну допомогу Україні обравший будь-який благодійний фонд на ваш вибір:

- [Зробити добро](https://dobro.ua/en/member/operators/)
